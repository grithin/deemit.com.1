...
class Session{
	...
	*/
	...
	private static function makeKey(){
		return substr(sha1($_SERVER['REMOTE_ADDR'].$_SERVER['HTTP_USER_AGENT'].$_COOKIE['sessionId']),0,10);
	}
	...
	static function create(){
			$id = md5($_SERVER['REMOTE_ADDR'].$_SERVER['HTTP_USER_AGENT'].microtime().rand(1,20));
