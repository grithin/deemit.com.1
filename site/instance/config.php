...
///Determines whether to try to load page utilities for a request prior to loading controllers
/**The loading will be in the display/utilities and utilities folders and start with the most specific (all tokens) and work its way down (all tokens - n) until it finds something or finished with no tokens left*/
$config['loadPageUtilities'] = true;
...
$config['emailUniqueId'] = 'scoop-mail';
